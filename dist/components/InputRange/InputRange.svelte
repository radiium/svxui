...
.InputRange.InputRange-full-width {
  width: 100%;
}
.InputRange.InputRange-size-1 {
...
.InputRange[disabled]:focus, .InputRange[disabled]:focus-within, .InputRange[disabled]:focus-visible {
