...
button.Button.Button-size-4.Button-icon-only {
...
button.Button:disabled:focus, button.Button:disabled:focus-within, button.Button:disabled:focus-visible {
