...
export let color = defaultBadgeProps.color;
export let disabled = defaultBadgeProps.disabled;
...
.Badge.Badge-disabled:focus, .Badge.Badge-disabled:focus-within, .Badge.Badge-disabled:focus-visible {
