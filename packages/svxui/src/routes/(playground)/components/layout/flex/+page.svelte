<script lang="ts">
    import { Flex } from '$lib/components/layout/index.js';
    import { Panel, Text } from '$lib/index.js';
    import Playground from '../../../controls/Playground.svelte';
</script>

<h1>layout/flex</h1>
<Text muted size="2">Conteneur flex avec direction, gap, justify, align</Text>

<Playground>
    <Flex direction="column" gap="3">
        <code>direction="row" justify="between"</code>
        <Flex direction="row" justify="between" gap="2" class="p-2 dashed">
        ...
        <Flex direction="column" align="center" gap="2" class="p-2 dashed">
