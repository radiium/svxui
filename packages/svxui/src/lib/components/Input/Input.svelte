<script lang="ts">
    ...
    export let color: $$Props['color'] = defaultInputProps.color;
    export let size: $$Props['size'] = defaultInputProps.size;
    export let radius: $$Props['radius'] = defaultInputProps.radius;
    export let align: $$Props['align'] = defaultInputProps.align;
    export let fullWidth: $$Props['fullWidth'] = defaultInputProps.fullWidth;
    export let readonly: $$Props['readonly'] = defaultInputProps.readonly;
