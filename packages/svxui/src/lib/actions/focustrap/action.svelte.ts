import type { FocusindexElement, FocusTrapActionReturn, FocusTrapParameters } from './types.js';

/**
 * Traps focus within a wrapper element
 *
 * credit: https://github.com/skeletonlabs
 */
export function focusTrapAction(
    node: HTMLElement,
    initialParams: FocusTrapParameters
): FocusTrapActionReturn {
    let enabled = initialParams.enabled;
