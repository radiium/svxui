import { clickoutside, focustrap } from '$lib/attachments/index.js';
import { kbd } from '$lib/internals/kbd.js';
import { flushSync } from 'svelte';
import { createAttachmentKey } from 'svelte/attachments';
import { on } from 'svelte/events';
import { FloatingEngine } from '../floating-engine/floating-engine.svelte.js';
import type { FloatingEngineOptions } from '../floating-engine/types.js';
import { useId } from '../use-id.js';
import type { FloatingPatternState, FloatingStateOptions, FloationgPatternContext } from './types.js';
import { FloatingPattern } from './floating-pattern.js';
...
export class FloatingState {
    ...
    constructor(options: FloatingStateOptions) {
