<script lang="ts">
    ...
    export let elementRef: $$Props['elementRef'] = defaultBadgeProps.elementRef;
    ...
    export let radius: $$Props['radius'] = defaultBadgeProps.radius;
...
<style lang="scss">
    .Badge {
        ...
        &.Badge-soft {
            --badge-box-shadow: none;
            --badge-background: var(--accent-a3);
            --badge-color: var(--accent-a11);
        }
        &.Badge-surface {
            --badge-box-shadow: inset 0px 0px 0px 1px var(--accent-a6);
            --badge-background: var(--accent-surface);
            --badge-color: var(--accent-a11);
        }
        &.Badge-outline {
            --badge-box-shadow: inset 0px 0px 0px 1px var(--accent-a8);
