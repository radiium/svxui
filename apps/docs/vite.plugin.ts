 ...
 * Example:
 * ```typescript
 * import Button, { source } from './Button.svelte?withSource&hideScript&hideComments';
 * ```
 *
 * Exports:
 * - source.raw: Original unmodified source code
 * - source.filtered: Source code after applying filters
 * - source.highlighted: Syntax highlighted HTML
 * - source.config: Configuration object with applied options
 */
